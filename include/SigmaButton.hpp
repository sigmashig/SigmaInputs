...
typedef enum
{
    ...
    SIGMA_BUTTON_EVENT_SIMPLE_CLICK,
    SIGMA_BUTTON_EVENT_LONG_CLICK,
    SIGMA_BUTTON_EVENT_LONG_LONG_CLICK,
    SIGMA_BUTTON_EVENT_DOUBLE_CLICK,
    SIGMA_BUTTON_EVENT_RELEASE,
    SIGMA_BUTTON_EVENT_SIMPLE_RELEASE,
    SIGMA_BUTTON_EVENT_LONG_RELEASE,
    SIGMA_BUTTON_EVENT_LONG_LONG_RELEASE,
    SIGMA_BUTTON_EVENT_DOUBLE_RELEASE,
