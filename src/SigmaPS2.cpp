...
SigmaPS2::PSXButton SigmaPS2::GetPSXButton(String name)
{
    ...
    if (upperName == "PSXJOY_LEFTUP") return PSXJOY_LEFTUP;
    if (upperName == "PSXJOY_LEFTDOWN") return PSXJOY_LEFTDOWN;
    if (upperName == "PSXJOY_LEFTLEFT") return PSXJOY_LEFTLEFT;
    if (upperName == "PSXJOY_LEFTRIGHT") return PSXJOY_LEFTRIGHT;
    if (upperName == "PSXJOY_RIGHTUP") return PSXJOY_RIGHTUP;
    if (upperName == "PSXJOY_RIGHTDOWN") return PSXJOY_RIGHTDOWN;
    if (upperName == "PSXJOY_RIGHTLEFT") return PSXJOY_RIGHTLEFT;
    if (upperName == "PSXJOY_RIGHTRIGHT") return PSXJOY_RIGHTRIGHT;
...
String SigmaPS2::PSXButtonToString(uint button)
{
    switch (button)
    {
        ...
        case PSXJOY_LEFTUP: return "PSXJOY_LEFTUP";
        case PSXJOY_LEFTDOWN: return "PSXJOY_LEFTDOWN";
        case PSXJOY_LEFTLEFT: return "PSXJOY_LEFTLEFT";
        case PSXJOY_LEFTRIGHT: return "PSXJOY_LEFTRIGHT";
        case PSXJOY_RIGHTUP: return "PSXJOY_RIGHTUP";
        case PSXJOY_RIGHTDOWN: return "PSXJOY_RIGHTDOWN";
        case PSXJOY_RIGHTLEFT: return "PSXJOY_RIGHTLEFT";
        case PSXJOY_RIGHTRIGHT: return "PSXJOY_RIGHTRIGHT";
